var classroom = {
    ...
    students: [ { name:"Aayushi", age:20, city:"pune",    marks: [45,76,34], cat:"Gen"  },         
...
function studentByCity(c)
{

  let n=classroom.students.filter(function (student){
    return(student.city===c);
     
 });


 let selectedStudent=n.map(function(student){
  return student.name;
})
...
let studentName=studentByCity("jaipur");
